...
class BlocCameraPage extends StatefulWidget {
  const BlocCameraPage({super.key});

  @override
  State<BlocCameraPage> createState() => _BlocCameraPageState();
}

class _BlocCameraPageState extends State<BlocCameraPage> {
  @override
  void initState() {
    super.initState();
